...
-- CreateIndex
CREATE UNIQUE INDEX "available_slots_technicianId_dayOfWeek_startTime_endTime_key" ON "available_slots"("technicianId", "dayOfWeek", "startTime", "endTime");
...
-- AddForeignKey
ALTER TABLE "available_slots" ADD CONSTRAINT "available_slots_technicianId_fkey" FOREIGN KEY ("technicianId") REFERENCES "technician_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
